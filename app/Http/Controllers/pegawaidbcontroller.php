...
public function store(Request $request)
{
	...
	DB::table('pegawai')->insert([
		'pegawai_nama' => $request->nama, //koma jadi pemisah array
...
public function edit($id)
{
	...
	$pegawai = DB::table('pegawai')->where('pegawai_id','=',$id)->get();  //PAHAMIN, ambil nya pake id
    // mengambil data dari table pegawai, TANPA FILTERING
    //$pegawai = DB::table('pegawai')->get(); //hasilnya adalah array 2D, ini langsung manggil nama table
...
{
	// update data pegawai
	DB::table('pegawai')->where('pegawai_id',$request->id)->update([ //wajib ada kalo ga ke update semua
