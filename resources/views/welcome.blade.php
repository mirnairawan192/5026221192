...
Nama      : Mirna Irawan
NRP       : 5026221192
template  : https://bootstrapmade.com/demo/Day/ 
Web asli  : https://tkdn.bki.co.id/
-->
...
<img src="{{ asset('assets/img/FOTO BKI.jpg') }}" alt="" data-aos="fade-in">
<img src="{{ asset('assets/img/bki-04.jpg') }}" class="img-fluid" alt="">
...
<body class="index-page">
  ...
  <img src="{{ asset('assets/img/bki-04.jpg') }}" class="img-fluid" alt="">
        ...
        <nav id="navmenu" class="navmenu">
          <ul>
            <li><a href="#hero" class="active">Beranda<i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <li><a href="#about">Tentang Kami<i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <li><a href="#services">Informasi<i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <li><a href="#portfolio">Galeri TKDN<i class="bi bi-chevron-down toggle-dropdown"></i></a>
            
            <li class="dropdown"><a href="#"><span>Kontak Kami</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
              <ul>
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section dark-background">
      ...
      <img src="assets/img/FOTO BKI.jpg" alt="" data-aos="fade-in">

      <div class="container" data-aos="fade-up" data-aos-delay="100">
        <div class="row justify-content-start">
          <div class="col-lg-8">
            <h2>TKDN BKI - DIGITALISASI PROSES SERTIFIKASI TKDN</h2>
            <p>Proses Sertifikasi TKDN Menjadi Lebih CEPAT, AKUNTABEL, dan TRANSPARAN</p>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-up" data-aos-delay="100">
            <img src="assets/img/bki-04.jpg" class="img-fluid" alt="">
          </div>

          <div class="col-lg-6 order-2 order-lg-1 content" data-aos="fade-up" data-aos-delay="200">
            <h3>KENAPA HARUS BKI?</h3>
            <p class="fst-italic">
    ...
    <section id="cards" class="cards section">
      ...
      <div class="container">
        ...
        <div class="container section-title" data-aos="fade-up">
          <span>Rekapitulasi Pekerjaan Verifikasi TKDN BKI
          </span>
          <h2>Rekapitulasi Pekerjaan Verifikasi TKDN BKI
          </h2>
          <p class="fst-italic">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
            <div class="service-item position-relative">
              ...
              <a href="#" class="stretched-link">
                <h3>Direktorat Jenderal Perhubungan Laut melaksanakan Oversight Program Perjanjian Kerja Sama Pelaksanaan</h3>
              </a>
              <p>Direktorat Jenderal Perhubungan Laut melaksanakan Oversight di kantor Pusat PT Biro Klasifikasi Indonesia (Persero) ...</p>
              <p>Administrator pada 18 Oktober 2023
              </p>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
            <div class="service-item position-relative">
              ...
              <a href="#" class="stretched-link">
                <h3>Kantor Baru BKI Cabang Medan Tingkatkan Efektivitas dan Produktivitas Bisnis</h3>
              </a>
              <p>Sebagai holding BUMN jasa survei – IDSurvey, pada 2022, BKI Medan berkontribusi 17,5 persen ...</p>
              <p>‎　 </p>
              <p>‎　 </p>
              <p>Administrator pada 18 Oktober 2023</p>
              <a href="#" class="stretched-link"></a>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
            <div class="service-item position-relative">
              ...
              <a href="#" class="stretched-link">
                <h3>Biro Klasifikasi Indonesia (BKI) Gandeng Badak LNG Kembangkan Sumber Daya dan Sertifikasi Perkapalan</h3>
              </a>
              <p>PT Biro Klasifikasi Indonesia (Persero) atau BKI sebagai BUMN induk Holding IDSurvey prakarsai kerja sama ...</p>
              <p>Administrator pada 18 Oktober 2023
              </p>
              <a href="#" class="stretched-link"></a>
            </div>
...
<section id="call-to-action" class="call-to-action section dark-background">
  ...
  <img src="assets/img/FOTO BKI.jpg" alt="">
      ...
      <div class="container section-title" data-aos="fade-up">
        ...
        <h2>Galeri TKDN</h2>
          ...
          <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-product">
              <img src="assets/img/foto5.jfif" class="img-fluid" alt="">
              <div class="portfolio-info">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-product">
              <img src="assets/img/bki 8.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
      ...
      <div class="row gy-4">
        <div class="col-lg-4 col-md-6">
          <div class="footer-about">
            <img src="assets/img/logo.png" class="img-fluid" alt="" style="max-width: 150px; height: auto;">
            <div class="footer-contact pt-3">
              <!-- Anda bisa menambahkan informasi kontak jika perlu -->
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="footer-info">
            <h4>Hak Cipta © 2024 PT. Biro Klasifikasi Indonesia (PERSERO)</h4>
            <p>Jl. Yos Sudarso 38-40, Tanjung Priok, Jakarta - 14320</p>
            <p>Email: ho@bki.co.id | cs@bki.co.id</p>
            <p>Telp: +62 21 430 10 17 | +62 21 430 17 03</p>
          </div>
        </div>
